<%@ Page Title="" Language="C#" MasterPageFile="~/ngo/ngo.master" AutoEventWireup="true" CodeFile="clean_india.aspx.cs" Inherits="ngo_clean_india" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="container marg30">
        <div class="col-lg-6">
          ...
          <%--              <tr>
                            <td>
                                <asp:Button ID="Button3" runat="server" Text="Button" Width="200"/>
                            </td>
                        </tr>
          --%>         <%--     <tr>
                           <td>
                    ...
                    <table>
                        ...
                        <%--<tr>
                            <td>
                                <input type="button" id="btncmt" value="Comment" class="tbncomment" width="200"/>
                            </td>
                        </tr>
                        <tr>
                              <td>
