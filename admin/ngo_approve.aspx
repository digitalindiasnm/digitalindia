<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="ngo_approve.aspx.cs" Inherits="admin_ngo_approve" %>
                  ...
                  <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" >
                           <h3 style="color:maroon;text-align:center"  > NGO Approval Details </h3>
                            </div>
                     <div class="panel-body"> 
                          <%--    <div class="col-md-12">--%>
                                ...
                                <table class="table table-striped table-bordered table-hovers" style="text-align:center">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowCommand="GridView1_RowCommand1" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2">
                                        <Columns>
