<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="viewNGO.aspx.cs" Inherits="admin_viewNGO" %>
            ...
            <div id="page-inner">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="NGO Logo">
                                                <ItemTemplate>
