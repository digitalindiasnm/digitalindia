<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="ambassador_approve.aspx.cs" Inherits="admin_ambassador_approve" %>
                   ...
                   <div class="col-md-12 col-sm-16 col-xs-16">
                    <div class="panel panel-default">
                        <div class="panel-heading" >
                           <h3 style="color:maroon;text-align:center"  > Ambassadar Approval Details </h3>
                            </div>
                          <%--    <div class="col-md-12">--%>
