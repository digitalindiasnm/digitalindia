<%@ Page Language="C#" AutoEventWireup="true" CodeFile="printcom.aspx.cs" Inherits="admin_printcom" %>
...
<body>
    ...
    <div style="padding: 2px 50px">
        ...
        <asp:Image ID="imglogo" runat="server" Height="150px" ImageAlign="Left" AlternateText="Apcons"  ImageUrl="~/admin/logo.jpg" Width="250px"/>
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Company Logo" Visible="false" >
                                                <ItemTemplate>
